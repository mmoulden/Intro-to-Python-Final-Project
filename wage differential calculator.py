...
maleeddata1 = wagesheet.cell_value(38, 8)                                                                               ## pull data from BLS_Gender_Wage_Data.xls based on cell location on excell sheet
maleeddata2 = wagesheet.cell_value(39, 8)                                                                               ## all stored as global variables
maleeddata3 = wagesheet.cell_value(40, 8)
maleeddata4 = wagesheet.cell_value(41, 8)
...
maleagedata1 = wagesheet.cell_value(7, 8)
maleagedata2 = wagesheet.cell_value(8, 8)
maleagedata3 = wagesheet.cell_value(9, 8)
maleagedata4 = wagesheet.cell_value(10, 8)
maleagedata5 = wagesheet.cell_value(11, 8)
maleagedata6 = wagesheet.cell_value(12, 8)
maleagedata7 = wagesheet.cell_value(13, 8)
...
class calculator(object):                                                               ##calculator class containing all methods used in main class
    ...
    def maleexperience():                           ## creates an experience multiplier for the male worker (uses average 3% yearly raise assumption as income increase to experience)
        maleexp = int(mexp)
        mexpadjust = 1.03**maleexp                  ## Updated 1/31/23
        return mexpadjust
    ...
    def femaleexperience():                         ## creates an experence multiplier for the female worker (uses average 3% yearly raise assumption as income increase to experience)
        femaleexp = int(fexp)
        fexpadjust = 1.03**femaleexp                ## Updated 1/31/23
        return fexpadjust
